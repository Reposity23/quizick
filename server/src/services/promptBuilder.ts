...
export function buildGrokSystemPrompt(): string {
  return `You are a strict quiz JSON generator.
...
- For code in prompts, use triple backticks inside the JSON string values (frontend will render as code window).

Output exam-ready, clear, cleanly written questions. Return JSON only.`;
}
